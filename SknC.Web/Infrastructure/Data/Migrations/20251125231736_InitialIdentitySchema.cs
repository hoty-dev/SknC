        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InciName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    CommonName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Concentration = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductIngredients", x => new { x.ProductReferenceId, x.IngredientId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductIngredients_ProductReferences_ProductReferenceId",
                        column: x => x.ProductReferenceId,
                        principalTable: "ProductReferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
